...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFE53935);
  late Color alternate = const Color(0xFFF3A328);
  late Color primaryText = const Color(0xFF1C1C1C);
  late Color secondaryText = const Color(0xFFADB4C9);
  late Color primaryBackground = const Color(0xFFF0F1F5);
  late Color secondaryBackground = const Color(0xFFADB4C9);
  late Color accent1 = const Color(0xFFF3A328);
  late Color accent2 = const Color(0xFF1976D2);
  late Color accent3 = const Color(0xFFADB4C9);
  late Color accent4 = const Color(0xFFF0F1F5);
  late Color success = const Color(0xFF1976D2);
  late Color warning = const Color(0xFFF3A328);
