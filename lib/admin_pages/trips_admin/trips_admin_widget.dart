...
import 'trips_admin_model.dart';
export 'trips_admin_model.dart';

class TripsAdminWidget extends StatefulWidget {
  const TripsAdminWidget({super.key});

  static String routeName = 'tripsAdmin';
  static String routePath = '/tripsAdmin';

  @override
  State<TripsAdminWidget> createState() => _TripsAdminWidgetState();
}

class _TripsAdminWidgetState extends State<TripsAdminWidget> {
  ...
  void _openTripDetails(TripsViewRow trip) {
    context.pushNamed(
      TripsdetailsAdminWidget.routeName,
      queryParameters: {
  ...
  Widget _buildDetailsLink(BuildContext context, TripsViewRow trip) {
    return InkWell(
  ...
  Widget _buildManagementButton(BuildContext context, TripsViewRow trip) {
    return InkWell(
      splashColor: Colors.transparent,
      focusColor: Colors.transparent,
      hoverColor: Colors.transparent,
  ...
  Widget _buildManagementPanel(BuildContext context, TripsViewRow trip) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 4.0),
          Expanded(
            child: _buildManagementButton(context, trip),
          ),
        ],
      ),
    );
          ...
          child: Stack(
            ...
            children: [
              ...
              PositionedDirectional(
                ...
                child: _buildDetailsLink(context, trip),
              ),
              PositionedDirectional(
              ...
              PositionedDirectional(
                ...
                child: _buildManagementPanel(context, trip),
              ),
            ],
          ),
        );
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TripsAdminModel());
    _loadActiveTrips();
  }
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (trips.isEmpty) {
                        return KgEmptyState(
                          ...
                          message:
                              'Создайте новый рейс, чтобы пассажиры могли оставить заявку.',
                          icon: Icons.directions_car_outlined,
                        );
                      }
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return _buildAdaptiveTripCard(context, trips[index]);
                        },
                      );
                    },
                  ),
