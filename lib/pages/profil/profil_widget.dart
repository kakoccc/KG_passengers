...
class _ProfilWidgetState extends State<ProfilWidget> {
  ...
  late Future<List<UsersRow>> _profileFuture;

  final scaffoldKey = GlobalKey<ScaffoldState>();

  void _loadProfile() {
    _profileFuture = UsersTable().queryRows(
  ...
  void initState() {
    ...
    _model.tgFocusNode ??= FocusNode();

    _model.imoFocusNode ??= FocusNode();
  }
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasError) {
                        return KgErrorState(
                          ...
                          message:
                              'Проверьте подключение и попробуйте открыть профиль ещё раз.',
                      ...
                      List<UsersRow> profilUsersRowList = snapshot.data!;
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadDataIvv = true);
                                ...
                                try {
                                  ...
                                  if (context.mounted) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Не удалось загрузить фото. Проверьте подключение и попробуйте ещё раз.',
                                        ),
                                  ...
                                  if (mounted) {
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataIvv = false);
                                  }
                                }
                                if (!context.mounted) {
                                  return;
                                ...
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length &&
                                    downloadUrls.first.isNotEmpty) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadDataIvv =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadDataIvv =
                                        downloadUrls.first;
                                  });
                                } else {
                                  safeSetState(() {});
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    ...
                                    backgroundColor: Color(0xFFDCF5E5),
                                  ),
                                );
                              },
                              child: Container(
                                ...
                                child: ClipOval(
                                  child: Stack(
                                    alignment: AlignmentDirectional(0.0, 0.0),
                                    children: [
                                      kgNetworkImageOrPlaceholder(
                                        context,
                                        imageUrl: profilUsersRowList
                                      ...
                                      if (_model.isDataUploading_uploadDataIvv)
                                        Container(
                                          width: 96.0,
                                          height: 96.0,
                                ...
                                if (_model.isEditing == false)
                                  Text(
                                    valueOrDefault<String>(
                                      profilUsersRowList.firstOrNull?.firstName,
                                      'Имя',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                    ...
                                    onTap: () async {
                                      await UsersTable().update(
                                        data: {
                                          ...
                                          'telegram':
                                              _model.tgTextController.text,
                                          'imo': _model.imoTextController.text,
                                          'first_name':
                                      ...
                                      Padding(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/Ico56789899n.png',
                                            width: 40.0,
                                            height: 40.0,
                                            fit: BoxFit.cover,
                                          ),
